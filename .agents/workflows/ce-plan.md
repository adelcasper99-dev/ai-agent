...
- Use the ce-repo-research-analyst skill to: Scope: technology, architecture, patterns. {planning context summary}
- Use the ce-learnings-researcher skill to: planning context summary
Collect:
...
- Use the ce-best-practices-researcher skill to: planning context summary
- Use the ce-framework-docs-researcher skill to: planning context summary
...
- Use the ce-spec-flow-analyzer skill to: planning context summary, research findings
