...
description: UX design review with heuristic scoring and visual hierarchy analysis.
---
...
2. **Confirm the target slugs cleanly & ensure storage directory exists**:
   ```bash
   mkdir -p .impeccable/critique 2>/dev/null || true
